...
schema_view = get_schema_view(
    openapi.Info(
        title="Blog API",
        default_version='v1',
        description="A Blog app based on CBV and DRF",
        terms_of_service="https://github.com/MRA-AK/django-blog/blob/main/LICENSE",
...
urlpatterns = [
    ...
    path('drf-docs/', include_docs_urls(title='Blog API')),
